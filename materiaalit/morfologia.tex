...
pääte on /а/ ja genetiivillä on kaksi päätettä, /ø/ ja /ей/ (sanoilla, joilla
yksikön nominatiivissa liudentunut vartalon viimeinen äänne ja nominatiivin
pääte kirjoitusasussa е: поле, море ym.).

\begin{longtable}[c]{@{}llllp{4cm}p{3cm}}
\toprule
    Sija & Päätemorfi & esim. 1 & esim.2 & esim. 3\tabularnewline
\midrule
\endhead
    Nom.   & /а/   & времена   & гнёзда  & поля \tabularnewline
    Gen.   & /ø/   & времён    & гнёзд   & полей \tabularnewline
    Akk.   & /и/   & времена   & гнёзда   & поля\tabularnewline
    Dat.   & /ам/  & временам  & гнездам  & полям\tabularnewline
    Instr. & /ами/ & временами & гнездами & полями\tabularnewline
    Prep.  & /ах/  & временах  & гнездах  & полях \tabularnewline
\bottomrule
\end{longtable}
...
\emph{статей} osuu väistyvän vokaalin piiriin, vaikkei ensi
...
Monikon genetiivimuoto \emph{статей} saattaa vielä hämätä. Miten niin
